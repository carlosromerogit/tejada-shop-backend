...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    stock_products: Schema.Attribute.Relation<
      'oneToMany',
      'api::stock-product.stock-product'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCartStockProductCartStockProduct
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cart-stock-product.cart-stock-product'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ...
    stock_product: Schema.Attribute.Relation<
      'manyToOne',
      'api::stock-product.stock-product'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart_stock_products: Schema.Attribute.Relation<
      'oneToMany',
      'api::cart-stock-product.cart-stock-product'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiStockProductStockProduct
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cart-stock-product.cart-stock-product': ApiCartStockProductCartStockProduct;
      ...
      'api::stock-product.stock-product': ApiStockProductStockProduct;
